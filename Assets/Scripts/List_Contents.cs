...
public class List_Contents : MonoBehaviour
{
    ...
    private readonly string Path_Touch = @"C:\KidingKiding_App\Game\Touch";
    private readonly string Path_Motion = @"C:\KidingKiding_App\Game\Motion";

    private readonly string Path_GreekMythologyImage = @"C:\KidingKiding_App\Resource\Image\GreekMythology";
    private readonly string Path_MVImage = @"C:\KidingKiding_App\Resource\Image\Music";
    private readonly string Path_StoryImage = @"C:\KidingKiding_App\Resource\Image\Story";
    private readonly string Path_TouchImage = @"C:\KidingKiding_App\Resource\Image\Touch";
    private readonly string Path_MotionImage = @"C:\KidingKiding_App\Resource\Image\Motion";
