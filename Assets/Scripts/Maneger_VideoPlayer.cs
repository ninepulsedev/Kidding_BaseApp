...
public class Maneger_Player : MonoBehaviour, IPointerDownHandler, IDragHandler
{
    ...
    string Path = "C:\\KidingKiding_App\\Resource\\Movie";
    ...
    public void Play_Story()
    {
        ...
        string fileName = m_List_Contents.m_ListStory[m_List_Contents.m_StoryIndex].name;
    ...
    public void Play_GreekMythology()
    {
        ...
        string fileName = m_List_Contents.m_ListGreekMythology[m_List_Contents.m_GreekMythologyIndex].name;
    ...
    public void Play_MV()
    {
        ...
        string fileName = m_List_Contents.m_ListMV[m_List_Contents.m_MVIndex].name;
